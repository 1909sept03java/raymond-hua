...
SELECT * FROM REIMBURSEMENT WHERE EMPLOYEE_ID = 1 AND PAD = 0 ORDER BY REIMBURSEMENT_ID;
UPDATE REIMBURSEMENT SET PAD = 2 WHERE REIMBURSEMENT_ID = 51;
SELECT * FROM REIMBURSEMENT WHERE EMPLOYEE_ID = 1 AND PAD = 2 ORDER BY REIMBURSEMENT_ID
